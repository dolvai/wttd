...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Ivaldo de Paula', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('ivaldosicchieri@yahoo.com.br', email.body)
        self.assertIn('16-98153-0680', email.body)
